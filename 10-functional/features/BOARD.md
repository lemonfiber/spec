...
| [A3](a-getting-started/a3-credential-validation.md) | Credential validation | A | operator | accepted | `0.2.0`, `0.9.0` |
| [A4](a-getting-started/a4-reconfiguration.md) | Reconfiguration | A | operator | accepted | `0.9.0` |
| [A5](a-getting-started/a5-migration.md) | Migration from an existing stack | A | operator | accepted | `0.9.0` |
| [A6](a-getting-started/a6-uninstall.md) | Clean uninstall | A | operator | accepted | `0.9.0` |
...
| [C8](c-trust/c8-provider-health.md) | Provider health & quota tracking | C | operator | accepted | `0.5.0` |
...
| [D4](d-content/d4-request-flow.md) | Household request flow | D | household | accepted | `0.8.0` |
| [D5](d-content/d5-disk-space.md) | Disk space management | D | operator | accepted | `0.8.0` |
| [D6](d-content/d6-household-identity.md) | Household identity & invitations | D | both | accepted | `0.8.0` |
| [D7](d-content/d7-approval-quotas.md) | Request approval & quotas | D | both | accepted | `0.8.0` |
| [D8](d-content/d8-parental-controls.md) | Parental controls | D | both | accepted | `0.8.0` |
...
| [F2](f-extensibility/f2-service-catalogue.md) | Service catalogue | F | operator | accepted | `0.9.0` |
