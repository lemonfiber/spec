...
Every one of them is given capabilities and the probes that demonstrate them. This is not
...
- [F2 Service catalogue](f2-service-catalogue.md) — the services these describe in machine terms
