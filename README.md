...
| **[10-functional](10-functional/)** | The 77-feature catalogue, numbered requirements, and nine user journeys | …you're deciding what to build or verifying it got built |
...
|---------|--------|----------|
| 00-overview | Accepted | Vision, glossary, roadmap, 23 ADRs |
