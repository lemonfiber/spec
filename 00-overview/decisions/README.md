...
| [0028](0028-a-supported-major-is-data-proved-by-its-own-recordings.md) | A supported major is data the stack declares, proved by its own recordings | Proposed |
| [0029](0029-a-household-service-declines-an-invitation-with-one-key.md) | A household service declines an invitation, holding one media-server key and nothing else | Proposed |
