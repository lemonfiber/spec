...
| **GOV-R48** | A requirement defined in a Draft document MUST NOT be cited by an implementation change, and the gate MUST refuse one by saying it is Draft and naming the document that defines it. |
